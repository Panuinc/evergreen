...
export const menuData = [
  ...
  },
  {
    ...
    subMenus: [
      ...
      { name: "Ap", icon: Package, href: "/warehouse/inventory/Ap" },
      { name: "Bp", icon: Package, href: "/warehouse/inventory/Bp" },
      { name: "Fa", icon: Package, href: "/warehouse/inventory/Fa" },
      { name: "Fg", icon: Package, href: "/warehouse/inventory/Fg" },
      { name: "Is", icon: Package, href: "/warehouse/inventory/Is" },
      { name: "Pk", icon: Package, href: "/warehouse/inventory/Pk" },
      { name: "Rm", icon: Package, href: "/warehouse/inventory/Rm" },
      { name: "Sm", icon: Package, href: "/warehouse/inventory/Sm" },
      { name: "Sp", icon: Package, href: "/warehouse/inventory/Sp" },
      { name: "Sv-Buy", icon: Package, href: "/warehouse/inventory/Sv-Buy" },
      { name: "Sv-Buy1", icon: Package, href: "/warehouse/inventory/Sv-Buy1" },
      { name: "Sv-Buy2", icon: Package, href: "/warehouse/inventory/Sv-Buy2" },
      { name: "Sv-Buy3", icon: Package, href: "/warehouse/inventory/Sv-Buy3" },
      { name: "Sv-Sell", icon: Package, href: "/warehouse/inventory/Sv-Sell" },
      { name: "Tr", icon: Package, href: "/warehouse/inventory/Tr" },
      { name: "Wp", icon: Package, href: "/warehouse/inventory/Wp" },
    ],
  },
  {
    id: "legal",
