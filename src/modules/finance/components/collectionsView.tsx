...
const pieColors = ["#F5A524", "#006FEE", "#9353D3", "#F31260", "#17C964", "#71717A", "#F97316", "#0EA5E9"];
...
function reasonColor(v): any { return reasons.find((r) => r.value === v)?.color || "default"; }
function statusLabel(v) { return statuses.find((s) => s.value === v)?.label || v || "-"; }
function statusColor(v): any { return statuses.find((s) => s.value === v)?.color || "default"; }
function contactLabel(v) { return contactMethods.find((m) => m.value === v)?.label || v || "-"; }
