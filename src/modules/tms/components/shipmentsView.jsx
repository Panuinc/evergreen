  ...
  const renderCell = useCallback(
    (item, columnKey) => {
      switch (columnKey) {
        ...
        case "tmsShipmentStatus":
          return (
            <Chip
              ...
              size="md"
              radius="md"
              color={statusColors[item.tmsShipmentStatus] || "default"}
            >
              {statusLabels[item.tmsShipmentStatus] || item.tmsShipmentStatus}
            </Chip>
          );
        case "isActive":
          return (
        ...
        case "actions": {
          const nextStatuses = nextStatus[item.tmsShipmentStatus] || [];
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {shipmentStops.length > 1 ? (
                  ...
                  <>
                    ...
                    <div className="flex items-center w-full h-fit p-2 gap-2">
                      <Input label="จุดเริ่มต้น" labelPlacement="outside" variant="bordered" size="md" radius="md" value={companyHq.address} isReadOnly />
                    </div>
                    <div className="flex items-center w-full h-fit p-2 gap-2">
