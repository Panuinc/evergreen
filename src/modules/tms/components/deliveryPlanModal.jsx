                ...
                >
                  <div className="flex flex-col gap-1 flex-1 min-w-0">
                    <div className="flex items-center gap-2 flex-wrap">
                      <Chip
                        size="md"
                        color={statusColors[plan.tmsDeliveryPlanStatus]}
                        variant="flat"
                      >
                        {statusLabels[plan.tmsDeliveryPlanStatus]}
                      </Chip>
                      <Chip
                        size="md"
                        color={priorityColors[plan.tmsDeliveryPlanPriority] || "primary"}
                        variant="flat"
                      >
                        {priorityLabels[plan.tmsDeliveryPlanPriority] || "ปกติ"}
                      </Chip>
              ...
              {editingPlan ? (
                <>
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    <Chip
                      size="md"
                      color={statusColors[editingPlan.tmsDeliveryPlanStatus]}
                      variant="flat"
                    >
                      {statusLabels[editingPlan.tmsDeliveryPlanStatus]}
                    </Chip>
                    <Chip
                      size="md"
                      color={priorityColors[editingPlan.tmsDeliveryPlanPriority] || "primary"}
                      variant="flat"
                    >
                      {priorityLabels[editingPlan.tmsDeliveryPlanPriority] || "ปกติ"}
                    </Chip>
                  </div>
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      {editingPlan.tmsDeliveryPlanItem.map((item) => (
                        ...
                        >
                          ...
                          <p className="text-xs font-light text-primary whitespace-nowrap pl-2">
