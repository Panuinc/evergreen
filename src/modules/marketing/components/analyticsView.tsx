...
function KpiCard({ title, value, sub, icon: Icon, color, growth = undefined }: { title: any; value: any; sub: any; icon: any; color: any; growth?: any }) {
  return (
...
function PeriodCard({ title, revenue, orders, icon: Icon, color, growth = undefined, prevLabel = undefined }: { title: any; revenue: any; orders: any; icon: any; color: any; growth?: any; prevLabel?: any }) {
  return (
    <Card shadow="none" className="border border-border hover:border-primary transition-colors duration-200">
      <CardBody className="p-5 gap-1">
        <div className="flex items-center justify-between">
