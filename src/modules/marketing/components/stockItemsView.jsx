  ...
  const tableData = useMemo(
    () =>
      items.map((item) => {
        ...
        const totalCost = cost + fixedPacketCost + fixedShippingCost;
    ...
    (item, columnKey) => {
      switch (columnKey) {
        ...
        case "packetCost":
          return (
            <span className="block text-right text-muted-foreground">
              {fixedPacketCost.toLocaleString("th-TH", { minimumFractionDigits: 2 })}
            </span>
          );
        case "shippingCost":
          return (
            <span className="block text-right text-muted-foreground">
              {fixedShippingCost.toLocaleString("th-TH", { minimumFractionDigits: 2 })}
            </span>
          );
        case "totalCost":
          return (
