...
interface DataTableProps {
  ...
  defaultSortDescriptor?: Partial<SortDescriptor>;
  emptyContent?: string;
  enableCardView?: boolean;
  getRowClassName?: (item: Record<string, any>) => string | undefined;
  actionMenuItems?: (item: Record<string, any>) => ActionMenuItem[];
}
